# Wrapper script to automate the model building process for a slouching classifier trained on all users' data with more weight on the target user as explored in notebooks/app_data_epa.ipynb
